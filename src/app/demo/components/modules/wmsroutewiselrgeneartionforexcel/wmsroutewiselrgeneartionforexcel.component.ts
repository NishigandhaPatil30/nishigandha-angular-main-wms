...
@Component({
  selector: 'app-wmsroutewiselrgeneartionforexcel',
  templateUrl: './wmsroutewiselrgeneartionforexcel.component.html',
  styleUrl: './wmsroutewiselrgeneartionforexcel.component.scss',
  providers:[MessageService]
})
export class WmsroutewiselrgeneartionforexcelComponent implements OnInit {
  data: LRData[] = [];
  ReferenceDoNo: any;
  ...
  saveDataToDatabase(): void {
    ...
    // Send the data to the PHP script
    this.http.post<string[]>('https://www.swatpro.co/insert_dataforxcel.php', this.data).subscribe(
      (generatedLRs) => {
...
setTimeout(() => {
  this.router.navigate(
    ['modules', 'lrgenration', 'wmsroutewiselrgeneartionforexcel', encodedReferenceDoNo, 'Lrno'],

...
@Component({
  selector: 'app-gridmasterview',
  templateUrl: './gridmasterview.component.html',
  styleUrls: ['./gridmasterview.component.scss'],
  standalone: true,
...
export class GridmasterviewComponent {
  students:any[]=[];
  Id:any;
  ...
  private messageService: MessageService
   ...
   ELEMENT_DATA: USER[] = [];
    ...
    displayedColumns: string[] = ['Id','Client code','Warehause no','Grid','Locationlenght(feet)','Locationwidth(feet)','Locationheight(feet)','Cubic Feet','Box Available Space','Grid Margin','Edit','Delete'];
  ...
  if (userInfoString) {
    ...
    loadData(depot: string): void {
      ...
      this.isLoading = true;
      let URL = `https://www.swatpro.co/wmsgridmastershowdepowise.php?depot=${depot}`;
        console.log(URL);
      fetch(URL)

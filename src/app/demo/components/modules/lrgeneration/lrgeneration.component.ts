...
@Component({
  selector: 'app-lrgeneration',
  templateUrl: './lrgeneration.component.html',
  styleUrls: ['./lrgeneration.component.scss']
})
export class LrgenerationComponent implements OnInit {
  data: RouteData[] = [];
...
depot:any;
  ...
  fetchDataForReferenceDoNo() {
    ...
    const apiUrl = `https://www.swatpro.co/fetchstockpendingdepowise.php?datepick=${fromDate}&datepick1=${toDate}&Depot=${Depot}`;
  ...
  this.router.navigate(['modules/lrgenration/wmsroutewiselrgeneartion',ReferenceDoNo]); 
}
}

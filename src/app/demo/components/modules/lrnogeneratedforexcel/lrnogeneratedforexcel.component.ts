...
@Component({
  selector: 'app-lrnogeneratedforexcel',
  templateUrl: './lrnogeneratedforexcel.component.html',
  styleUrl: './lrnogeneratedforexcel.component.scss'
})
export class LrnogeneratedforexcelComponent implements OnInit {
